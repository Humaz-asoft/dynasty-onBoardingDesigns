        ...
        <>
            <div className="custom-container">
                ...
                <div className="action-btns">
                    <Link to="/step4" className="back"><span className="icon fa fa-arrow-left"></span>Back </Link>
                    <Link to="/step6" className="btn-orange">Continue <span className="icon fa fa-arrow-right"></span></Link>
                </div>
            </div>
        </>
    );
